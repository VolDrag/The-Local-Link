// Feature 19 - Anupam: Customer Booking History Page
    ...
    <div className="booking-history-page">
      ...
      <div className="booking-history-container">
        <div className="history-header">
          ...
          <p className="subtitle">View and manage all your past and upcoming bookings</p>
        </div>
        ...
        <div className="bookings-section">
          <h3>Booking Records ({bookings.length})</h3>
          ...
          {bookings.length === 0 ? (
            <div className="no-bookings">
              ...
              <button onClick={() => navigate('/services')} className="btn-browse">
                Browse Services
              </button>
            </div>
          ) : (
                  ...
                  <div className="booking-card-body">
                    <div className="booking-info-row">
                      ...
                      <div className="info-content">
                        ...
                        <span className="info-value">{booking.provider?.name || 'N/A'}</span>
                      </div>
                    </div>
